...
2. <span style={{ color: '#216694' }}>@Trusted</span> networking options are like <span
       style={{ color: '#1A6D34' }}
   >
       <span style={{ color: '#1A6D34' }}>@Students</span>
   </span> but extend to their exclusive channels.
...
6. [Sub-Communities](/services/community/sub-communities)
