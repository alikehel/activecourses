...
| Course                                                                      | Link                                                                   |
| :-------------------------------------------------------------------------- | :--------------------------------------------------------------------- |
| Introduction to Programming                                                 | [Link](/resources/core/programming/introduction-to-programming)        |
| Programming with a Purpose                                                  | [Link](/resources/core/programming/programming-with-a-purpose)         |
| Programming Languages                                                       | [Link](/resources/core/programming/programming-languages)              |
| Introduction to Programming + Programming Languages + OOP + Problem-Solving | [Link](/resources/core/programming/course-dr-mostafa-saad-udemy)       |
| Databases                                                                   | [Link](/resources/core/datastructures-and-algorithms/course-princeton) |
